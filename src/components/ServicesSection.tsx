...
const AnimatedPrice = ({ price }: { price: string }) => {
  ...
  // Extract leading number from price string (e.g. "S/. 80 a 150" → 80, "Desde S/. 70" → 70)
...
const ArrowPulse = ({ delay }: { delay: number }) => {
  ...
  useEffect(() => {
    ...
    // initial delay offset so cards don't all pulse at once
