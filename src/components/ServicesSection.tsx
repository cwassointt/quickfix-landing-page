    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <motion.div variants={sectionVariants} initial="hidden" animate={isInView ? "visible" : "hidden"} className="flex flex-col items-center mb-16 text-center">
          <motion.span variants={headerVariants} className="text-orange-500 font-medium text-sm tracking-widest uppercase inline-block mb-3">Catálogo 2026</motion.span>
          <motion.h2 variants={headerVariants} className="text-4xl md:text-5xl font-bold text-white tracking-tight">Nuestros Servicios</motion.h2>
          <motion.p variants={headerVariants} className="mt-4 text-white/40 max-w-2xl font-light text-lg">Cada servicio incluye lavado químico, descontaminado y acabado con encerado mate.</motion.p>
        </motion.div>
